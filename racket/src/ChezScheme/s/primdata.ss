...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (box [sig [(ptr) -> (mutable-box)]] [flags unrestricted alloc])
  (box? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  (box-cas! [sig [(mutable-box ptr ptr) -> (boolean)]] [flags safeongoodargs cptypes2])
  ...
  (set-box! [sig [(mutable-box ptr) -> (void)]] [flags true safeongoodargs cptypes2])
